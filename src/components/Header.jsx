    ...
    return (
        <header className="min-h-screen flex flex-col justify-center items-center p-6">
            <div className="text-center">
                ...
                <p className="text-sm font-mono text-amber-400">Hi, my name is</p>

                <h1 className="text-4xl font-bold text-sky-500 mt-2 font-fira">Arslan Javaid</h1>

                <h1 className="text-2xl font-bold text-sky-700">Full Stack Developer</h1>
